	...
	perform_test : function() {
		new Test.Unit.Runner({
			...
			test_link_to_unless : function(){with (this) {
				assertEqual("<a href='/reply' >Reply</a>",	 
					this.view.link_to_unless(false, 'Reply', '/reply')
				);
				assertEqual("Reply",	 
					this.view.link_to_unless(true, 'Reply', '/reply')
				);
			}},

			test_link_to_if : function(){with (this){
				assertEqual("<a href='/reply' >Reply</a>",	 
					this.view.link_to_if(true, 'Reply', '/reply')
				);
				assertEqual("Reply",
					this.view.link_to_if(false, 'Reply', '/reply')
				);
			}},

			test_link_to_unless_current : function(){with (this){
				assertEqual("<a href='/reply' >Reply</a>",	 
					this.view.link_to_unless_current('Reply', '/reply')
				);
				assertEqual("Reply",
					this.view.link_to_unless_current('Reply', window.location.pathname)
				);
			}},
